...
**Layer 2 — Classify:** One Claude API call, temperature=0, structured
...
**Layer 4 — Generate:** One Claude API call with retrieved chunks as
...
## Dependencies
```
anthropic, rank-bm25, langdetect, pandas, python-dotenv
```
